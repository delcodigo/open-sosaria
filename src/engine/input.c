...
void input_keyCallback(GLFWwindow* window, int key, int scancode, int action, int mods) {
  ...
  switch (key) {
    ...
    case GLFW_KEY_B:
      if (action == GLFW_RELEASE) {
        input.b = 0;
      } else if (input.b == 0 && action == GLFW_PRESS) {
        input.b = 1;
      }
      break;
    case GLFW_KEY_X:
      if (action == GLFW_RELEASE) {
        input.x = 0;
      } else if (input.x == 0 && action == GLFW_PRESS) {
        input.x = 1;
      }
      break;
    case GLFW_KEY_F:
      if (action == GLFW_RELEASE) {
        input.f = 0;
      } else if (input.f == 0 && action == GLFW_PRESS) {
        input.f = 1;
      }
      break;
    case GLFW_KEY_E:
    ...
    case GLFW_KEY_U:
      if (action == GLFW_RELEASE) {
        input.u = 0;
      } else if (input.u == 0 && action == GLFW_PRESS) {
        input.u = 1;
      }
      break;
    case GLFW_KEY_K:
      if (action == GLFW_RELEASE) {
        input.k = 0;
      } else if (input.k == 0 && action == GLFW_PRESS) {
        input.k = 1;
      }
      break;
    case GLFW_KEY_V:
      if (action == GLFW_RELEASE) {
        input.v = 0;
      } else if (input.v == 0 && action == GLFW_PRESS) {
        input.v = 1;
      }
      break;
    case GLFW_KEY_H:
      if (action == GLFW_RELEASE) {
        input.h = 0;
      } else if (input.h == 0 && action == GLFW_PRESS) {
        input.h = 1;
      }
      break;
  }
